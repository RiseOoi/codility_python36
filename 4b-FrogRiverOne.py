...
# The frog can cross only when leaves appear at
...
# this problem is also just a variation of 3r, 3a, and 4a
# checking if something exists is a set problem
# so let's reuse the magic sauce from 4a
def solution(X, A):
    river = set()
    pred_sum = (X + 1) * X // 2
    river_sum = 0
